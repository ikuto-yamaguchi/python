...
from .english_role_compiler import EnglishRoleReferenceResolver
...
def main() -> None:
    ...
    reference_resolver = EnglishRoleReferenceResolver()
    ...
    json.dump(
        {
            ...
            "metadata": {
                ...
                "reference_compiler_count": reference_resolver.compiler_count,
