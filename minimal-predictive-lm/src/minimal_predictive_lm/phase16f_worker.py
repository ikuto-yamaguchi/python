...
def main() -> None:
    ...
    if not source_path:
        raise RuntimeError("MPM_WORDNET_ZIP is required for Phase 16f")
    ...
    json.dump(
        {
            ...
            "metadata": {
                ...
                "induced_clause_compiler_bits": (
                    proposition_machine.induced_clause_compiler.description_bits
                ),
                "induced_clause_templates": len(
                    proposition_machine.induced_clause_compiler.templates
                ),
                "canonical_clause_observations": (
                    proposition_machine.induced_clause_compiler.training_observations
                ),
                "human_designed_surface_compilers": (
                    state_machine.compiler_count
                    + temporal_machine.human_designed_surface_compilers
                    + proposition_machine.human_designed_surface_compilers
                ),
                "induced_surface_compilers": proposition_machine.induced_surface_compilers,
                "benchmark_task_name_branches": (
                    state_machine.benchmark_task_name_branches
                    + temporal_machine.benchmark_task_name_branches
                    + proposition_machine.benchmark_task_name_branches
                ),
