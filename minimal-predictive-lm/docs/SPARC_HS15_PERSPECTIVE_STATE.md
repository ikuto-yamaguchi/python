# SPARC-HS15: learned perspective and event-state workspace

HS15 targets three weaknesses that directly block natural conversation: state change, reference focus, and the difference between the actual world and another person's belief.
