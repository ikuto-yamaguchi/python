...
class AdaptiveSparcRuntime:
    ...
    The runtime combines bounded dialogue/fact memory, verified symbolic
    mechanisms, programs induced from demonstrations, and a proof-producing
    Japanese passage reasoner behind one API and one serialized artifact.
    """
    ...
    def load(cls, path: str | Path) -> "AdaptiveSparcRuntime":
        ...
        if data.get("format") not in {"adaptive-sparc-hs16-v1", "adaptive-sparc-hs16-v2"}:
